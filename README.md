...
* Have latest RotorHazard 4.2 and above installed on a timer or on a laptop. Installations instrutions are available at http://rotorhazard.com.
* Track in velocidrone must have the Start & Stop gate checked. Support for different Start & Stop gates will be coming in next release. 
